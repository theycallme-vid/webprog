...
<body class="antialiased">
	<!-- navbar -->
	<div x-data="{ open: false }" class="w-full text-gray-700 ">
        <div class="flex flex-col max-w-screen-xl px-8 mx-auto md:items-center md:justify-between md:flex-row">
            <div class="flex flex-row items-center justify-between py-6">
                <div class="relative md:mt-8">
                    ...
                    <!-- LOGO UBAYA -->
                     <img src="img/ubaya/logo1.png" width="340px">
            ...
            <nav :class="{ 'transform md:transform-none': !open, 'h-full': open }" class="h-0 md:h-auto flex flex-col flex-grow md:items-center pb-4 md:pb-0 md:flex md:justify-end md:flex-row origin-top duration-300 scale-y-0">
                <a class="px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline" href="#">Pendaftaran</a>
                <a class="px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline" href="#">Program Studi</a>
                <a class="px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline" href="#">International Programs</a>
                <a class="px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline" href="#">Ubaya West Campus</a>
                <a class="px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline" href="#">Fasilitas</a>
	...
	<div class="bg-cream">
		<div class="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
			...
			<div class="flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
				<h1 data-aos="fade-right" data-aos-once="true" class="my-4 text-5xl font-bold leading-tight text-darken1">
					<span class="text-yellow-500">The First</span> University and Heart and Mind
				</h1>
				<p data-aos="fade-down" data-aos-once="true" data-aos-delay="300" class="leading-normal text-2xl mb-8" style="color: white;">Universitas Surabaya berkomitmen mencetak lulusan unggul, inovatif, dan siap menghadapi tantangan global.</p>
	...
	<div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
		...
		<div class="max-w-4xl mx-auto">
			<h1 class="text-center mb-3 text-gray-400 font-medium" style="font-size: 25px;">Penghargaan</h1>
		</div>
        <img class="w" src="img/ubaya/penghargaan.jpg" style="width: 100%; justify-content:center" >
        <br>
        <!-- EDUCATION PARTNER -->
		<div class="max-w-4xl mx-auto">
			<h1 class="text-center mb-3 text-gray-400 font-medium" style="font-size: 25px;">Education Partner</h1>
		</div>
        <div class="flex justify-center">
            <img src="img/ubaya/coursera.jpg" style="width: 30%;">
        </div>


		<!-- All-In-One Cloud Software. -->
        <div data-aos="flip-up" class="w-full mx-auto text-center mt-24">
            <h1 class="font-bold text-darken my-3 text-2xl">
                Universitas <span class="text-yellow-500">Surabaya.</span>
            </h1>
            ...
            <div class="w-full max-w-5xl mx-auto mt-10">
                <div class="relative w-full" style="padding-bottom: 56.25%;">
                    <iframe 
                        ...
                        src="https://www.youtube.com/embed/wZ1c9ZGIcH4"
                        frameborder="0"
                        allowfullscreen>
                    </iframe>
                </div>
		...
		<div class="flex flex-col md:flex-row items-center md:space-x-10 mt-16">
			<div data-aos="fade-right" class="md:w-1/2 lg:pl-14">
				<h1 class="text-darken font-semibold text-3xl lg:pr-56"><span class="text-yellow-500">Rektor</span> Speech </h1>
				<p class="text-gray-500 my-4 lg:pr-32">Universitas Surabaya (UBAYA) yang berdiri sejak 11 Maret 1968, telah mencapai fase lima puluh tahun (usia emas) pada tahun 2018. Sejak awal berdirinya sampai saat ini dan di masa yang akan datang, UBAYA tetap memiliki komitmen utuh untuk mengutamakan kualitas.</p>
			</div>
			<img data-aos="fade-left" class="md:w-1/2" src="img/ubaya/rektor.png">
		</div>
